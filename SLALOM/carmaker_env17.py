...
class CarMakerEnv(gym.Env):
    def __init__(self, host='127.0.0.1', port=10001, check=2, matlab_path='C:\CM_Projects\han_230706\src_cm4sl', simul_path='pythonCtrl_env17'):
        ...
        self.traj_data_before = pd.read_csv("datasets_traj_SLALOM_env17.csv")
    ...
    def getReward(self, state, time):
        ...
        if self.test_num % 300 == 0 and self.check == 0:
            print("[Time: {}], [tx : {}], [Reward : {}], [Dist : {}]".format(time, car_x, e, round(reward_devDist,2)))
