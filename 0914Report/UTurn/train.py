...
from carmaker_env21 import CarMakerEnv
...
#    Args = namedtuple('Args', ['prefix', 'alg'])
    ...
    env = VecMonitor(env, "C:/CM_Projects/code/carmaker_env{}/models/{}".format(env_num, naming))
...
#    model = SAC.load("C:/Users/ku347/PycharmProjects/carmaker6/models/{}/10997_best_model.pkl".format(naming), env=env, verbos=1, tensorboard_log=os.path.join("tensorboard/{}/Additional_study".format(naming)))
    ...
    try:
        ...
        print("Saving model..")
        model.save("C:/CM_Projects/code/carmaker_env{}/models/model_{}_last.pkl".format(env_num, naming))
        print("Model saved.")
