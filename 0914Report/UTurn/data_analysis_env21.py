...
#수정하는 부분
road_types = 'UTurn'
df_traj = pd.read_csv('datasets_traj_UTurn_env21.csv')
...
cones = [[10 + 10 * 0, 1.5, 11], [10 + 10 * 1, 1.5, 11],
         [10 + 10 * 2, 1.5, 11], [10 + 10 * 3, 1.5, 11],
         [10 + 10 * 4, 1.5, 11], [10 + 10 * 5, 1.5, 11],
         [10 + 10 * 6, 1.5, 11], [10 + 10 * 7, 1.5, 11],
         [10 + 10 * 8, 1.5, 11], [10 + 10 * 9, 1.5, 11]
         ]
car_width = 1.568
car_length = 4.3
